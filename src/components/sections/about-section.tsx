...
export function AboutSection({ scrollToSection }: { scrollToSection?: (index: number) => void }) {
  ...
  return (
    <section
      ref={ref}
      data-section
      className="flex w-full shrink-0 flex-col justify-center px-4 py-12 md:h-screen md:w-screen md:snap-start md:items-center md:py-0 md:pt-0 md:px-12 lg:px-16"
    >
          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                ...
                с любовью
                <br />
                <span className="text-foreground/40">к улыбкам</span>
              </h2>
            </div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Мы команда врачей, которые действительно заботятся о каждом пациенте. Без очередей, без боли, без страха.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Современное оборудование, мягкая анестезия и индивидуальный подход — наш стандарт с первого визита.
              </p>
            </div>
          </div>
