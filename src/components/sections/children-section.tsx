        ...
        >
          {[
            ...
            >
              ...
              <h3 className="mb-0.5 font-sans text-sm font-semibold text-foreground md:text-base transition-all duration-300 group-hover:bg-gradient-to-br group-hover:from-[#f472b6] group-hover:to-[#a78bfa] group-hover:bg-clip-text group-hover:text-transparent">{item.title}</h3>
