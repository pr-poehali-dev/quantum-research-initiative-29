        ...
        >
          {[
            ...
            >
              ...
              <h3 className="mb-1 font-sans text-base font-semibold text-foreground md:text-lg transition-all duration-300 group-hover:bg-gradient-to-br group-hover:from-[#f472b6] group-hover:to-[#a78bfa] group-hover:bg-clip-text group-hover:text-transparent">{item.title}</h3>
              <p className="max-w-sm text-sm leading-snug text-foreground/80 md:text-base">{item.description}</p>
              {item.price && <p className="mt-1 font-mono text-sm font-semibold md:text-base" style={{ color: "#fbbf24", textShadow: "0 0 12px rgba(251, 191, 36, 0.5), 0 0 24px rgba(251, 191, 36, 0.25)" }}>{item.price}</p>}
            </div>
          ))}
        </div>
